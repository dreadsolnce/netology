...
#### Вирутальная машнина бастион с публичныи айпи адресом и установленным nginx для проксирования трафика на внутренние vm 
#### Развернут кластер k8s на трех мастер нодах (3-ех VM) с возможностью размещения на них подов.
