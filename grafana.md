...
<img width="533" height="617" alt="Screenshot_175" src="https://github.com/user-attachments/assets/a442d57b-6457-4558-a4c4-b98798d55382" />
...
```
{
  ...
  "panels": [
    {
      "datasource": null,
      "description": "Определяет колличество лдоступной свободной памяти",
      "fieldConfig": {
        "defaults": {
          "color": {
            "mode": "thresholds"
    ...
    },
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "Привет получай свой алерт в телеграм",
        "name": "Нагрузка на ЦПУ за 1 минуту",
      ...
      "dashes": false,
      "datasource": null,
      "description": "Среднее время нагрузки на процессор",
      "fieldConfig": {
        "defaults": {
          "color": {},
          "custom": {},
      ...
      "targets": [
        {
          "expr": "node_load1",
          "interval": "",
          "legendFormat": "load avarage 1 min",
          "refId": "A"
        },
        {
          "expr": "node_load5",
          "hide": false,
          "interval": "",
          "legendFormat": "load avarage 5 min",
          "refId": "B"
        },
        {
          "expr": "node_load15",
          "hide": false,
          "interval": "",
          "legendFormat": "load avarage 15 min",
          "refId": "C"
        }
      ],
      "thresholds": [
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Средняя загрузка процессора за 1, 5, 15 минут",
      "tooltip": {
        "shared": true,
        "sort": 0,
    ...
    },
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "Кончилось место",
        "name": "Свободное место alert",
        "noDataState": "no_data",
        "notifications": []
      },
      "aliasColors": {},
